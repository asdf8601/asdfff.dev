...
date: 2024-11-25
tag: [uv, makefile, python]
category: programming
---

This is a revisited version of my previous post about Makefiles, but this time
using uv (the shiny new Python package manager that's faster than a caffeinated
cheetah).

I was tired of typing the same commands over and over in my Python projects, so
I made this Makefile using uv.

Feel free to steal it — I mean, borrow it — for your own projects.
